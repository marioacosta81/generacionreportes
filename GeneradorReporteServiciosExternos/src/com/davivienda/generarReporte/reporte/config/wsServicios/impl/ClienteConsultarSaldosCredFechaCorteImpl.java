...
import com.davivienda.generarReporte.servicios.consultaSaldosCredFecha.ConsultaSaldosCredFechaCorteDataHeaderType;
import com.davivienda.generarReporte.servicios.consultaSaldosCredFecha.ConsultaSaldosCredFechaCorteDataType;
import com.davivienda.generarReporte.servicios.consultaSaldosCredFecha.ConsultaSaldosCredFechaCortePortType;
import com.davivienda.generarReporte.servicios.consultaSaldosCredFecha.ConsultaSaldosCredFechaCorteService;
import com.davivienda.generarReporte.servicios.consultaSaldosCredFecha.RequestConsultaSaldosCredFechaCorte;
import com.davivienda.generarReporte.servicios.consultaSaldosCredFecha.ResponseType;
...
public class ClienteConsultarSaldosCredFechaCorteImpl extends ClienteServiciosAbstract implements IClienteServicios<ResponseType> {

    private final DataHeaderComunESB headerComunESB = this.obtenerHeaderDelServicio("clienteSOAPSaldosCredFecha");
    private final ParametrosSoapServicio paramSoapService = this.obtenerServicioDelConfig("clienteSOAPSaldosCredFecha");
    private RequestConsultaSaldosCredFechaCorte request;
    private final String nombre;
    private static final String CARACTER_ACEPTACION_OK = "B";
    private int  valTerminalAsig = 0;
    public ClienteConsultarSaldosCredFechaCorteImpl(Logger logger, String nom) throws ErrorExternServiceException {
        super(logger);
        this.nombre = nom;
    }
    ...
    public void nuevo(short idCanal) throws ErrorExternServiceException {
        this.setRequest((RequestConsultaSaldosCredFechaCorte) null);
        this.verificarCanal(this.paramSoapService, idCanal);
        if (this.service == null) {
            this.service = new ConsultaSaldosCredFechaCorteService();
        }
    ...
    public void asignarInformacion(MsjSolOpGeneracionReporte infoRequestMsg, BigDecimal valor) throws ErrorExternServiceException {
        ConsultaSaldosCredFechaCorteDataType data = new ConsultaSaldosCredFechaCorteDataType();
        ConsultaSaldosCredFechaCorteDataHeaderType header = new ConsultaSaldosCredFechaCorteDataHeaderType();
        ...
        this.request = new RequestConsultaSaldosCredFechaCorte();
        this.request.setData(data);
        this.request.setDataHeader(header);
    }

    public Object invocar() throws ErrorExternServiceException {
        this.logger.info("inicio invocar ConsultaSaldosCredFechaCorte con terminal = " + valTerminalAsig);
        ConsultaSaldosCredFechaCortePortType proxy = ((ConsultaSaldosCredFechaCorteService) this.service).getConsultaSaldosCredFechaCortePort();
        ...
        try {
            ...
            response = proxy.consultaSaldosCredFechaCorte(this.request);
            if (response != null) {
                if (response.getDataHeader() != null) {
                    if (response.getDataHeader().getCaracterAceptacion().equalsIgnoreCase("B")) {
                        if (response.getData() != null) {
                            ...
                            errorMsj = "ConsultaSaldosCredFechaCorte: Data de consulta de saldos credito fecha corte es null";
                        }
                    } else {
                        errorMsj = "ConsultaSaldosCredFechaCorte: " + response.getDataHeader().getMsgRespuesta();
                    }
                } else {
                    errorMsj = "ConsultaSaldosCredFechaCorte: Dataheader de consulta de saldos credito fecha corte es null";
                }
            } else {
                errorMsj = "ConsultaSaldosCredFechaCorte: Error al consumir el servicio del BUS";
            }
            ...
            String mensaje = "Error al consumir el servicio ConsultaSaldosCredFechaCorte";
            ...
            if (var18) {
                long total = fin - ini;
                this.logger.debug("Tiempo de consumo de servicio ConsultaSaldosCredFechaCorte : " + total + " MS");
            }
        }

        long total = fin - ini;
        this.logger.debug("Tiempo de consumo de servicio ConsultaSaldosCredFechaCorte : " + total + " MS");
        this.logger.debug("fin invocar ConsultaSaldosCredFechaCorte");
    ...
    public void setRequest(RequestConsultaSaldosCredFechaCorte request) {
