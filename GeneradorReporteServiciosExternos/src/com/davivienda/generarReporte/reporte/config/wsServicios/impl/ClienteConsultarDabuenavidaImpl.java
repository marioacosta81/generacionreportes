...
import com.davivienda.generarReporte.servicios.dabuenavida.ConsultaSaldoTituloDabuenavidaDataHeaderType;
import com.davivienda.generarReporte.servicios.dabuenavida.ConsultaSaldoTituloDabuenavidaDataType;
import com.davivienda.generarReporte.servicios.dabuenavida.ConsultaSaldoTituloDabuenavidaPortType;
import com.davivienda.generarReporte.servicios.dabuenavida.FabricaCredito03HTTPService;
import com.davivienda.generarReporte.servicios.dabuenavida.RequestConsultaSaldoTituloDabuenavida;
import com.davivienda.generarReporte.servicios.dabuenavida.ResponseType;
...
public class ClienteConsultarDabuenavidaImpl extends ClienteServiciosAbstract implements IClienteServicios<ResponseType> {

    private final DataHeaderComunESB headerComunESB = this.obtenerHeaderDelServicio("clienteSOAPDabuenavida");
    private final ParametrosSoapServicio paramSoapService = this.obtenerServicioDelConfig("clienteSOAPDabuenavida");
    private RequestConsultaSaldoTituloDabuenavida request;
    private final String nombre;
    private static final String CARACTER_ACEPTACION_OK = "B";
    private int  valTerminalAsig = 0;
    public ClienteConsultarDabuenavidaImpl(Logger logger, String nom) throws ErrorExternServiceException {
        super(logger);
        this.nombre = nom;
    }
    ...
    public void nuevo(short idCanal) throws ErrorExternServiceException {
        this.setRequest((RequestConsultaSaldoTituloDabuenavida) null);
        this.verificarCanal(this.paramSoapService, idCanal);
        if (this.service == null) {
            this.service = new FabricaCredito03HTTPService();
        }
    ...
    public void asignarInformacion(MsjSolOpGeneracionReporte infoRequestMsg, BigDecimal valor) throws ErrorExternServiceException {
        ConsultaSaldoTituloDabuenavidaDataType data = new ConsultaSaldoTituloDabuenavidaDataType();
        ConsultaSaldoTituloDabuenavidaDataHeaderType header = new ConsultaSaldoTituloDabuenavidaDataHeaderType();
        ...
        try {
            ...
            data.setTipoDeProducto(Short.valueOf(infoRequestMsg.getProducto().getCodigoTipoProducto()));
        ...
        this.request = new RequestConsultaSaldoTituloDabuenavida();
        this.request.setData(data);
        this.request.setDataHeader(header);
    }

    public Object invocar() throws ErrorExternServiceException {
        this.logger.info("inicio invocar ConsultaSaldoTituloDabuenavida con terminal = " + valTerminalAsig );
        ConsultaSaldoTituloDabuenavidaPortType proxy = ((FabricaCredito03HTTPService) this.service).getFabricaCredito03HTTPPort();
        ...
        try {
            ...
            response = proxy.consultaSaldoTituloDabuenavida(this.getRequest());
            if (response != null) {
                if (response.getDataHeader() != null) {
                    if (response.getDataHeader().getCaracterAceptacion().equalsIgnoreCase("B")) {
                        if (response.getData() != null) {
                            ...
                            errorMsj = "ConsultaSaldoTituloDabuenavida: Data de consulta de dabuenavida es null";
                        }
                    } else {
                        errorMsj = "ConsultaSaldoTituloDabuenavida: " + response.getDataHeader().getMsgRespuesta();
                    }
                } else {
                    errorMsj = "ConsultaSaldoTituloDabuenavida: Dataheader de consulta de dabuenavida es null";
                }
            } else {
                errorMsj = "ConsultaSaldoTituloDabuenavida: Error al consumir el servicio del BUS";
            }
            ...
            String mensaje = "Error al consumir el servicio ConsultaSaldoTituloDabuenavida";
            ...
            if (var18) {
                long total = fin - ini;
                this.logger.debug("Tiempo de consumo de servicio ConsultaSaldoTituloDabuenavida : " + total + " MS");
            }
        }

        long total = fin - ini;
        this.logger.debug("Tiempo de consumo de servicio ConsultaSaldoTituloDabuenavida : " + total + " MS");
        this.logger.debug("fin invocar ConsultaSaldoTituloDabuenavida");
    ...
    public void setRequest(RequestConsultaSaldoTituloDabuenavida request) {
