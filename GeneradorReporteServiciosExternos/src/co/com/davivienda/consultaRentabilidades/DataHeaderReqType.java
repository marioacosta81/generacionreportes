...
@XmlType(
        name = "DataHeaderReqType",
        propOrder = {"nombreOperacion", "total", "jornada", "canal", "modoDeOperacion", "usuario", "perfil", "versionServicio", "idTransaccion"}
)
public class DataHeaderReqType {

    @XmlElement(
            required = true,
            defaultValue = "ConsultaRentabilidades"
    )
