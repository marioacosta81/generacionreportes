...
@XmlType(name = "ConsultaDetalleCredHipotecarioLeasingDataHeaderType", propOrder = {"nombreOperacion", "total", "jornada", "canal", "modoDeOperacion", "usuario", "perfil", "versionServicio"})
public class ConsultaDetalleCredHipotecarioLeasingDataHeaderType {

    @XmlElement(required = true, defaultValue = "ConsultaDetalleCredHipotecarioLeasing")
