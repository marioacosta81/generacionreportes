...
@XmlType(name = "ConsultaSaldoTituloDabuenavidaDataHeaderType", propOrder = {"nombreOperacion", "total", "jornada", "canal", "modoDeOperacion", "usuario", "perfil", "versionServicio"})
public class ConsultaSaldoTituloDabuenavidaDataHeaderType
        implements Serializable {

    @XmlElement(required = true, defaultValue = "ConsultaSaldoTituloDabuenavida")
    ...
    public String toString() {
        return "ConsultaSaldoTituloDabuenavidaDataHeaderType{nombreOperacion=" + this.nombreOperacion + ", total=" + this.total + ", jornada=" + this.jornada + ", canal=" + this.canal + ", modoDeOperacion=" + this.modoDeOperacion + ", usuario=" + this.usuario + ", perfil=" + this.perfil + ", versionServicio=" + this.versionServicio + '}';
    }
}
