...
public class DataHeaderRespType
    ...
    public String toString() {
        return "DataHeaderRespType{nombreOperacion=" + this.nombreOperacion + ", total=" + this.total + ", caracterAceptacion=" + this.caracterAceptacion + ", ultimoMensaje=" + this.ultimoMensaje + ", codMsgRespuesta=" + this.codMsgRespuesta + ", msgRespuesta=" + this.msgRespuesta + '}';
    }
}
