...
@XmlType(name = "ConsultaDeDivisasDataHeaderType", propOrder = {"nombreOperacion", "total", "jornada", "canal", "modoDeOperacion", "usuario", "perfil", "versionServicio"})
public class ConsultaDeDivisasDataHeaderType
        implements Serializable {

    @XmlElement(required = true, defaultValue = "ConsultaDeDivisas")
