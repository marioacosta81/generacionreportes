...
@XmlType(name = "DataHeaderRequestType", propOrder = {"nombreOperacion", "total", "jornada", "canal", "modoDeOperacion", "usuario", "perfil", "versionServicio"})
public class DataHeaderRequestType
        implements Serializable {

    @XmlElement(required = true, defaultValue = "ConsultaSaldosAhorros")
    ...
    public String toString() {
        return "DataHeaderRequestType{nombreOperacion=" + this.nombreOperacion + ", total=" + this.total + ", jornada=" + this.jornada + ", canal=" + this.canal + ", modoDeOperacion=" + this.modoDeOperacion + ", usuario=" + this.usuario + ", perfil=" + this.perfil + ", versionServicio=" + this.versionServicio + '}';
    }
}
