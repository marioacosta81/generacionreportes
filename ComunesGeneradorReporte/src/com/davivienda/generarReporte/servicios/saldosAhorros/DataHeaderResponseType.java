...
@XmlType(name = "DataHeaderResponseType", propOrder = {"nombreOperacion", "total", "caracterAceptacion", "ultimoMensaje", "codMsgRespuesta", "msgRespuesta"})
public class DataHeaderResponseType
    ...
    public String toString() {
        return "DataHeaderResponseType{nombreOperacion=" + this.nombreOperacion + ", total=" + this.total + ", caracterAceptacion=" + this.caracterAceptacion + ", ultimoMensaje=" + this.ultimoMensaje + ", codMsgRespuesta=" + this.codMsgRespuesta + ", msgRespuesta=" + this.msgRespuesta + '}';
    }
}
