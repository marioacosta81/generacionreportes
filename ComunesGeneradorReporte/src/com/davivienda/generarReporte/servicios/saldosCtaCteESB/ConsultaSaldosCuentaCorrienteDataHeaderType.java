...
@XmlType(name = "ConsultaSaldosCuentaCorrienteDataHeaderType", propOrder = {"nombreOperacion", "total", "jornada", "canal", "modoDeOperacion", "usuario", "perfil", "versionServicio"})
public class ConsultaSaldosCuentaCorrienteDataHeaderType
        implements Serializable {

    @XmlElement(required = true, defaultValue = "ConsultaSaldosCuentaCorriente")
