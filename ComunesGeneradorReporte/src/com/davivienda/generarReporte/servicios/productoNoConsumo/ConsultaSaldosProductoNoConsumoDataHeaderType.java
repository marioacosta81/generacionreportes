...
@XmlType(name = "ConsultaSaldosProductoNoConsumoDataHeaderType", propOrder = {"nombreOperacion", "total", "jornada", "canal", "modoDeOperacion", "usuario", "perfil", "versionServicio"})
public class ConsultaSaldosProductoNoConsumoDataHeaderType {

    @XmlElement(required = true, defaultValue = "ConsultaSaldosProductoNoConsumo")
    ...
    public String toString() {
        return "ConsultaSaldosProductoNoConsumoDataHeaderType{nombreOperacion=" + this.nombreOperacion + ", total=" + this.total + ", jornada=" + this.jornada + ", canal=" + this.canal + ", modoDeOperacion=" + this.modoDeOperacion + ", usuario=" + this.usuario + ", perfil=" + this.perfil + ", versionServicio=" + this.versionServicio + '}';
    }
}
