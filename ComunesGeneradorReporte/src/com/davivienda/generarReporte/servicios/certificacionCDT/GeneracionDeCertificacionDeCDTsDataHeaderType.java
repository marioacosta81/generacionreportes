...
@XmlType(name = "GeneracionDeCertificacionDeCDTsDataHeaderType", propOrder = {"nombreOperacion", "total", "jornada", "canal", "modoDeOperacion", "usuario", "perfil", "versionServicio"})
public class GeneracionDeCertificacionDeCDTsDataHeaderType
        implements Serializable {

    @XmlElement(required = true, defaultValue = "GeneracionDeCertificacionDeCDTs")
    ...
    public String toString() {
        return "GeneracionDeCertificacionDeCDTsDataHeaderType{nombreOperacion=" + this.nombreOperacion + ", total=" + this.total + ", jornada=" + this.jornada + ", canal=" + this.canal + ", modoDeOperacion=" + this.modoDeOperacion + ", usuario=" + this.usuario + ", perfil=" + this.perfil + ", versionServicio=" + this.versionServicio + '}';
    }
}
