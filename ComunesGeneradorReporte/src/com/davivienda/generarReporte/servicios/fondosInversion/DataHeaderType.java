...
@XmlType(name = "DataHeaderType", propOrder = {"nombreOperacion", "total", "jornada", "canal", "modoDeOperacion", "usuario", "perfil", "versionServicio"})
public class DataHeaderType
        implements Serializable {

    @XmlElement(required = true, defaultValue = "ConsultaFondosDeInversion")
    ...
    @XmlElement(required = true, defaultValue = "1.1.1")
    ...
    public String toString() {
        return "DataHeaderType{nombreOperacion=" + this.nombreOperacion + ", total=" + this.total + ", jornada=" + this.jornada + ", canal=" + this.canal + ", modoDeOperacion=" + this.modoDeOperacion + ", usuario=" + this.usuario + ", perfil=" + this.perfil + ", versionServicio=" + this.versionServicio + '}';
    }
}
